import { hasRole, generateStep } from './meeting.js'
import { messages } from './messages.js'
import { roles } from './roles.js'

export const getNextRegularStep = (io, meeting, actualStep) => {
...
export const diePLayers = (io, meeting, playerSelected, action) => {
  io.to(meeting.identifier).emit('resultAction', {
    for: '*',
    action,
    player: null,
